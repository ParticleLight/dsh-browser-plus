...
function resolveElectronPath() {
    ...
    throw new Error('dsh-browser-plus: cannot locate the Electron binary. Install electron in the host profile ' +
...
class RemoteView {
    ...
    async clearDialog() {
        return this.client.call('drainDialog', { viewId: this.id }).then(r => r?.result ?? null);
    }
    ...
    async listWindows() {
        const r = await this.client.call('listWindows');
        return r.windows;
    }
}
/**
