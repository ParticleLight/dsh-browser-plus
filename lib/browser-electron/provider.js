...
export class ElectronBrowserProvider {
    ...
    async clickRef(session, request, signal) {
        ...
        await tab.handle.sendCommand('Input.dispatchMouseEvent', { type: 'mousePressed', x: point.x, y: point.y, button: 'left', clickCount: 1 });
        await tab.handle.sendCommand('Input.dispatchMouseEvent', { type: 'mouseReleased', x: point.x, y: point.y, button: 'left', clickCount: 1 });
